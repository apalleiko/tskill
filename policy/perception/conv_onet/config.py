...
from policy.perception.conv_onet import model as mdl, training
# from policy.perception.conv_onet.onet import generation
from policy.perception.conv_onet import data
from policy import config
from policy.perception.common import decide_total_volume_range, update_reso
...
def get_model(cfg, device=None, dataset=None, **kwargs):
    ...
    decoder = decoder_dict[decoder](c_dim=c_dim, padding=padding,
        **decoder_kwargs
    )
    ...
    if encoder == 'idx':
        ...
        encoder = encoder_dict[encoder](c_dim=c_dim, padding=padding,
            **encoder_kwargs
        )
    else:
        encoder = None

    model = mdl.ConvolutionalOccupancyNetwork(
