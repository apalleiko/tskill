...
class TSkillCVAE(nn.Module):
    ...
    def __init__(self, stt_encoder, encoder, decoder, state_dim, action_dim, max_skill_len, z_dim, device, **kwargs):
        ...
        self.enc_src_pos_scale_factor = nn.Parameter(torch.ones(1) * 0.01)
        ...
        self.enc_output_norm = self.norm(self.hidden_dim)
        ...
        self.dec_output_norm = self.norm(self.hidden_dim)
    ...
    def skill_decode(self, z_sample, qpos, img_info, 
        ...
        # skills
        z = self.dec_input_z_norm(z) # (skill_seq, bs, hidden_dim)
        ...
        dec_output = self.dec_output_norm(dec_output) # (seq, bs, hidden_dim)
